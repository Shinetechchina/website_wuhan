...
Refinery::Images.configure do |config|
  ...
  config.user_image_sizes = {:small=>"110x110>", :medium=>"225x255>", :large=>"450x450>", :box=>"279x288#c", :double_box=>"564x288#c"}
  ...
  # config.dragonfly_secret = "13ad4e508592605dcceb1665ffdfa20f7a29a8ee488dd390"
  # If you decide to trust file extensions replace :ext below with :format
  # config.dragonfly_url_format = "/system/images/:job/:basename.:ext"
  # config.datastore_root_path = "/Users/david/Projects/website_wuhan/public/system/refinery/images"
