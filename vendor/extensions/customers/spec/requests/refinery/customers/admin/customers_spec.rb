    ...
    describe "Admin" do
      describe "customers" do
        ...
        describe "customers list" do
          before do
            FactoryGirl.create(:customer, :name => "UniqueTitleOne")
            FactoryGirl.create(:customer, :name => "UniqueTitleTwo")
          end
        ...
        describe "create" do
          ...
          context "duplicate" do
            before { FactoryGirl.create(:customer, :name => "UniqueTitle") }
        ...
        describe "edit" do
          before { FactoryGirl.create(:customer, :name => "A name") }
        ...
        describe "destroy" do
          before { FactoryGirl.create(:customer, :name => "UniqueTitleOne") }
